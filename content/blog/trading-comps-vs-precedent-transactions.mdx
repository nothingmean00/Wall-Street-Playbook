...
*This covers the key concepts from Chapter 4 of our [IB Technical Interview Guide](/playbooks/ib-technical-guide). The full chapter includes worked examples with real numbers, a step-by-step comps output table, and the "football field" construction framework.*
