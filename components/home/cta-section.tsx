        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <ScrollReveal animation="fade-up">
            <div className="inline-flex items-center gap-2 rounded-full border border-gold/30 bg-gold/10 px-4 py-1.5 mb-6">
              ...
              <span className="text-xs font-semibold uppercase tracking-widest text-gold">Resume Services</span>
            </div>
          </ScrollReveal>
          
          <ScrollReveal animation="fade-up" delay={100}>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white">
              Every Weak Resume Is an <span className="text-gradient-gold">Interview Lost</span>
            </h2>
            <p className="mt-4 sm:mt-6 text-base sm:text-lg text-white/60 max-w-xl mx-auto">
              Recruiters spend 30 seconds on your resume. One positioning mistake and you're in the reject pile—before they even see your skills.
            </p>
          </ScrollReveal>
          ...
          <ScrollReveal animation="fade-up" delay={200}>
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                ...
                onClick={() => track("cta_clicked", { location: "home_cta" })}
              ...
              <Link
                href="/jobs"
                onClick={() => track("cta_clicked", { location: "home_jobs" })}
          ...
          <ScrollReveal animation="fade" delay={400}>
            <p className="mt-8 text-sm text-white/40">
              Feedback based on what gets callbacks at bulge brackets, elite boutiques, and buyside firms.
            </p>
          </ScrollReveal>
        </div>
      </div>
