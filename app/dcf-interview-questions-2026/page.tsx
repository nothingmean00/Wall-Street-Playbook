          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-white/70">
                The full Finance Technical Interview Guide covers 8 chapters: Accounting, EV/Equity Value, DCF, Comps, M&A, LBOs, Advanced Valuation, and Complex Accounting. 300+ questions tagged by frequency. 80+ pages.
              </p>
              <div className="mt-8">
                <Link
                  href="/playbooks/finance-technical-interview-guide"
