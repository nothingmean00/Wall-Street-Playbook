          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-white/70">
                DCF is Chapter 3. Comps are Chapter 4. M&A (including precedent transactions) is Chapter 5. Plus Accounting, EV/Equity Value, and LBOs. 87 pages covering everything you'll be asked.
              </p>
              <div className="mt-8">
                <Link
                  href="/playbooks/ib-technical-guide"
