...
"[project]/Downloads/wall-street-playbook/app/api/jobs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function categorizeJob(title) {
    ...
    if (titleLower.includes("investment bank") || titleLower.includes("m&a") || titleLower.includes("ib analyst") || titleLower.includes("ib associate")) return "Investment Banking";
    if (titleLower.includes("private equity") || titleLower.includes("pe ") || titleLower.includes("buyout") || titleLower.includes("lbo")) return "Private Equity";
    if (titleLower.includes("hedge fund") || titleLower.includes("portfolio manager") || titleLower.includes("hf ") || titleLower.includes("long short")) return "Hedge Fund";
    if (titleLower.includes("asset management") || titleLower.includes("wealth") || titleLower.includes("aum")) return "Asset Management";
    if (titleLower.includes("equity research") || titleLower.includes("research analyst") || titleLower.includes("stock analyst")) return "Equity Research";
    if (titleLower.includes("trading") || titleLower.includes("trader") || titleLower.includes("sales") || titleLower.includes("market maker")) return "Sales & Trading";
    if (titleLower.includes("venture") || titleLower.includes("vc ") || titleLower.includes("startup")) return "Venture Capital";
    if (titleLower.includes("risk") || titleLower.includes("compliance")) return "Risk Management";
    if (titleLower.includes("corporate finance") || titleLower.includes("fp&a") || titleLower.includes("treasury")) return "Corporate Finance";
    return "Finance";
}
...
async function GET(request) {
    ...
    if (cacheValid && !refresh && !query && jobsCache) {
        ...
        const response = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wall$2d$street$2d$playbook$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            jobs,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__796393fd._.js.map