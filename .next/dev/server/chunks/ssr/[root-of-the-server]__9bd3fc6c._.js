...
"[project]/Downloads/wall-street-playbook/lib/mdx.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wall$2d$street$2d$playbook$2f$node_modules$2f$gray$2d$matter$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/wall-street-playbook/node_modules/gray-matter/index.js [app-rsc] (ecmascript)");
;
;
;
...
function contentDirExists() {
    return __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(contentDirectory);
}
...
function getPostBySlug(slug) {
    ...
    const { data, content } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wall$2d$street$2d$playbook$2f$node_modules$2f$gray$2d$matter$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])(fileContents);
    return {
        slug,
        title: data.title || "",
...
function getRelatedPosts(slug, category, limit = 4) {
    const allPosts = getAllPostsMeta();
    return allPosts.filter((post)=>post.slug !== slug && post.category === category).slice(0, limit);
}
...
"[project]/Downloads/wall-street-playbook/lib/blog.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wall$2d$street$2d$playbook$2f$lib$2f$mdx$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/wall-street-playbook/lib/mdx.ts [app-rsc] (ecmascript)");
;
;
// Convert data.ts guide to unified format
function guideToUnifiedMeta(guide) {
    return {
        slug: guide.slug,
        title: guide.title,
...
function guideToUnifiedPost(guide) {
...
function mdxToUnifiedMeta(post) {
    return {
        ...post,
        source: "mdx"
    };
}
function mdxToUnifiedPost(post) {
    return {
        ...post,
        source: "mdx"
    };
...
function getAllBlogPosts() {
    // Get MDX posts
    const mdxPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wall$2d$street$2d$playbook$2f$lib$2f$mdx$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllPostsMeta"])().map(mdxToUnifiedMeta);
    const mdxSlugs = new Set(mdxPosts.map((p)=>p.slug));
    // Get data.ts posts (excluding any that exist in MDX - MDX takes priority)
    const dataPosts = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wall$2d$street$2d$playbook$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["guides"].filter((g)=>!mdxSlugs.has(g.slug)).map(guideToUnifiedMeta);
...
function getBlogPost(slug) {
    ...
    const mdxPost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wall$2d$street$2d$playbook$2f$lib$2f$mdx$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getPostBySlug"])(slug);
    if (mdxPost) {
        return mdxToUnifiedPost(mdxPost);
    }
    // Fall back to data.ts
    const guide = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wall$2d$street$2d$playbook$2f$lib$2f$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["guides"].find((g)=>g.slug === slug);
    if (guide) {
...
function getRelatedBlogPosts(slug, category, limit = 4) {
    return getAllBlogPosts().filter((post)=>post.slug !== slug && post.category === category).slice(0, limit);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wall$2d$street$2d$playbook$2f$lib$2f$blog$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/wall-street-playbook/lib/blog.ts [app-rsc] (ecmascript)");
...
function BlogPage() {
    const allPosts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wall$2d$street$2d$playbook$2f$lib$2f$blog$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAllBlogPosts"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9bd3fc6c._.js.map