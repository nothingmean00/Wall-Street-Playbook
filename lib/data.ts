...
export const playbooks: Playbook[] = [
  {
    ...
    longDescription:
      "The definitive technical preparation guide for investment banking interviews. Covers every core concept tested at bulge brackets and elite boutiques—accounting, valuation, M&A, and LBO mechanics—with the precision and depth expected at the highest levels.",
    price: 79,
    contents: [
    ...
    excerpt:
      "Walk me through a DCF. Start with unlevered free cash flow: EBIT × (1 - tax rate) + D&A - CapEx - changes in NWC. Project 5-10 years, then calculate terminal value using either perpetuity growth or exit multiple method...",
  },
  {
    ...
    longDescription:
      "A tactical guide to finance networking that transforms cold outreach into warm relationships. Includes word-for-word scripts tested across bulge bracket and elite boutique recruiting, plus the follow-up cadences that keep you top of mind.",
    price: 49,
    contents: [
    ...
    excerpt:
      "Subject: Quick Question - [Firm] [Group] Hi [Name], I noticed you transitioned from [background] to [current role] at [firm]. I am currently [your situation] and would appreciate 15 minutes to hear about your experience...",
  },
  {
    ...
    longDescription:
      "The complete playbook for private equity recruiting. Master the compressed timelines of on-cycle processes, build headhunter relationships that matter, and prepare for the case studies and technicals that determine outcomes.",
    price: 99,
    contents: [
    ...
    excerpt:
      "PE recruiting operates on compressed timelines. On-cycle processes can move from first call to offer in under 48 hours. Preparation must be complete before the process begins—there is no time to learn during...",
  },
  {
    ...
    longDescription:
      "Transform your experiences into compelling narratives that resonate with interviewers. This systematic approach to behavioral interviews covers story banking, the optimized STAR method, and firm-specific patterns that help you stand out.",
    price: 59,
    contents: [
    ...
    excerpt:
      'Your "why finance" answer must connect three elements: relevant experience, demonstrated interest, and specific firm fit. Generic answers about "deal exposure" fail. Specific answers about a particular transaction type or sector succeed...',
  },
  {
    ...
    longDescription:
      "Preparation materials for hedge fund interviews across all major strategies. Covers stock pitch construction, investment thesis development, and the portfolio discussion frameworks that separate candidates at L/S equity, event-driven, and macro funds.",
    price: 89,
    contents: [
    ...
    excerpt:
      "A strong stock pitch follows a specific structure: (1) one-sentence thesis, (2) business overview, (3) variant perception, (4) catalysts, (5) valuation, (6) risks and mitigants. Most candidates fail at step 3...",
  },
  {
    ...
    longDescription:
      "A comprehensive recruiting management system that ensures you never miss a deadline. Includes timeline calendars for IB, PE, and hedge fund cycles, application tracking spreadsheets, and the frameworks to manage multiple processes simultaneously.",
    price: 29,
    contents: [
    ...
    excerpt:
      "Summer analyst recruiting typically opens in late July for bulge brackets, with first-round interviews in August and September. Elite boutiques often run slightly later cycles. Superdays cluster in September and October...",
  },
]
