...
export const playbooks: Playbook[] = [
  {
    ...
    description: "80-page, 8-chapter technical mastery guide with 300+ questions across 8 core topics. Every concept tagged by interview frequency, with detailed Q&A and red flag warnings. 2026 Edition.",
    longDescription:
      "Master the technical questions that determine who gets the offer and who goes home. This comprehensive 80-page, 2026 Edition guide covers all 8 core topics tested in IB, PE, and finance interviews—accounting fundamentals, enterprise value & equity value, DCF analysis, comparable company analysis, M&A, leveraged buyouts, advanced valuation, and complex accounting. With 300+ questions, every concept is tagged by how often it actually appears (Always Asked, Frequently Asked, Sometimes Asked, Rarely Asked), plus detailed transaction walk-throughs, formula cheat sheets, practice problems, and an industry multiples guide. Built differently from every other prep resource: interview frequency tags, critical distinction boxes, interviewer perspective insights, and worked examples that reveal the hidden evaluation criteria.",
    price: 79,
    contents: [
      "Chapter 1: Accounting Fundamentals — Three financial statements deep dive, how statements link together, working capital & cash flow dynamics, depreciation/CapEx/D&A, 25+ must-know accounting questions with full walk-throughs",
      "Chapter 2: Enterprise Value & Equity Value — The core EV/equity distinction, bridge formula deep dive, matching multiples correctly, common mistakes & pitfalls, must-know EV questions",
      "Chapter 3: Valuation & DCF Analysis — Six-step DCF framework, unlevered free cash flow, terminal value methods (perpetuity growth + exit multiple), WACC & cost of capital, sensitivity analysis",
      "Chapter 4: Comparable Company Analysis — Four-step comps process, trading multiples deep dive, precedent transactions, selecting comparable companies, must-know comps questions",
      "Chapter 5: Mergers & Acquisitions — Accretion/dilution analysis, goodwill & purchase price allocation, synergies & integration, deal structures & considerations, must-know M&A questions",
      "Chapter 6: Leveraged Buyouts — LBO core mechanics, good LBO candidate characteristics, IRR/MOIC & returns analysis, debt capacity & covenants, must-know LBO questions",
      "Chapter 7: Advanced Valuation — Sum-of-the-parts valuation, cross-border considerations, private company valuation & liquidity discounts, real options & other methods",
      "Chapter 8: Complex Accounting — Stock-based compensation treatment, deferred taxes & NOLs, lease accounting (ASC 842), pension accounting",
      "Appendix A: Formula Cheat Sheet — Every critical formula in one reference",
      "Appendix B: Practice Problems — Hands-on problems to test your knowledge",
      "Appendix C: Industry Multiples Guide — Sector-specific valuation benchmarks",
      "Interview Frequency Tags on every concept — ALWAYS ASKED, FREQUENTLY ASKED, SOMETIMES ASKED, RARELY ASKED — so you prioritize prep time",
    ],
    excerpt:
      "Every finance interview begins here. You must be able to walk through all three statements, explain how they connect, and trace any transaction through all of them. This is non-negotiable. Interviewers will test this repeatedly because it reveals whether you truly understand how businesses operate. The candidates who stand out are the ones who explain the intuition behind the mechanics, not just the mechanics themselves.",
  },
  {
    slug: "pe-recruiting-playbook",
    title: "2026 PE Recruiting Playbook",
    description: "The definitive 42-page, 15-chapter guide to PE recruiting. Timelines, headhunters, technicals, compensation data, and contrarian insights that go beyond conventional wisdom.",
    longDescription:
      "Private equity recruiting has reached an inflection point. This comprehensive 42-page, 15-chapter guide synthesizes 2023-2026 data from headhunter sources, industry practitioners, and proprietary research to give you actionable intelligence that contradicts or goes beyond mainstream advice. From the 7 headhunter firms that control megafund access to compensation data by level, from paper LBO frameworks to the contrarian insights that give you edge—this is everything you need to navigate on-cycle chaos, off-cycle opportunities, and everything in between.",
    price: 67,
    contents: [
      "Chapter 1: 2026 Market Landscape — Recruiting timeline forecast, market structure analysis, on-cycle vs. off-cycle dynamics, and how the 2026 cycle differs from prior years",
      "Chapter 2: The Headhunter Ecosystem — The 7 firms that control PE access (CPI, Henkel, SG Partners, Ratio, Amity, DSP, Oxbridge), their specialties, and how to approach each",
      "Chapter 3: Bank-to-Fund Pipeline — Which banks and groups place into which funds, placement data by group, and how to position yourself within your bank's pipeline",
      "Chapter 4: Non-Traditional Paths — MBB consulting, Big 4 TAS, corporate development, veterans, and other paths into PE with realistic timelines and requirements",
      "Chapter 5: Undergrad Direct Programs — Blackstone, KKR, Warburg Pincus, Apollo, Carlyle analyst programs, application timelines, and what makes candidates stand out",
      "Chapter 6: LBO Mechanics — Sources & uses from first principles, debt schedules, cash flow waterfall, returns analysis, and the intuition behind every calculation",
      "Chapter 7: Paper LBO Framework — The 10-minute method with full worked example, mental math shortcuts, and the presentation format that impresses interviewers",
      "Chapter 8: Modeling Tests — Time management framework, fatal errors to avoid, and how to handle the 3-hour take-home vs. 1-hour in-office format",
      "Chapter 9: Technical Deep Dive — Accounting, credit concepts, EV/equity bridge, and the follow-up questions that separate offers from dings",
      "Chapter 10: Behavioral & Fit — The 'Why PE' framework, deal discussion structure (60-second walkthrough), and culture signals for megafund vs. middle-market",
      "Chapter 11: Firm Selection — Megafund profiles (BX, KKR, Apollo, TPG, Carlyle, H&F), practitioner rankings, and optimizing for learning, comp, exits, or work-life balance",
      "Chapter 12: Compensation Data — 2025-2026 comp by level (Associate through Partner), megafund to LMM, base, bonus, carry, and co-invest breakdowns",
      "Chapter 13: Career Progression — Promotion rates, what distinguishes people who make Partner, and exit opportunities at each level",
      "Chapter 14: Networking & Applications — Email templates with high response rates, resume tailoring for PE, and the channel-by-channel effectiveness data",
      "Chapter 15: Contrarian Insights — 5 myths debunked (megafund obsession, on-cycle panic, technical overemphasis) with data showing why conventional wisdom fails",
  ...
  },
  {
    ...
    contents: [
      ...
      "Chapter 3: Informational Interview Mastery — 30 sophisticated questions by call phase, minute-by-minute 25-min call structure, converting interviews to referrals via the Mini-Ask and Real Ask",
      "Chapter 4: Networking Events & Coffee Chats — Bank event preparation, conversation starters that work in person, the 24-hour follow-up rule, the 80/20 listening principle",
      "Chapter 5: Building a Networking System — Google Sheets CRM with 22 fields, weekly cadence targets, volume benchmarks by candidate type (30–200+ emails), contact prioritization matrix",
      "Chapter 6: Segment-Specific Strategy — Calibrated playbooks for target school, non-target, career switchers, international candidates, MBA, and diversity candidates",
      "Chapter 7: Hard Data on Networking Effectiveness — Response rates by channel and scenario, how IB/PE/HF jobs are actually filled, the full conversion funnel from 200 emails to 1 offer",
      "Chapter 8: Contrarian Insights & What's Changing — Why MDs may respond more than analysts, the warm lead manufacturing system, why AI has made personalization the only differentiator",
      "Appendix A: Quick-Reference Cheat Sheets — Cold email checklist, informational interview cheat sheet, networking priority matrix, email formats for 13+ major banks, recruiting timelines",
      "Appendix B: Advanced Frameworks — Warm lead manufacturing system, 3-touch relationship escalation, seniority-adjusted communication matrix, non-target school acceleration playbook",
    ],
    excerpt:
  ...
  },
  {
    ...
    description: "41-page, 9-chapter behavioral mastery system. All 50 questions psychologically reverse-engineered with hidden objectives, a classification matrix mapping to 6 screening dimensions, the CARL+ framework, 7-story bank system, and firm-specific patterns for GS, JPM, MS, and elite boutiques. 2026 Edition.",
    longDescription:
    ...
    price: 47,
    contents: [
      "Introduction: The Hidden Interview — The 7 traits interviewers actually screen for (tedium tolerance, deference to hierarchy, coachability, social calibration, emotional resilience, low-maintenance, intellectual curiosity) and the 8 fears driving every question",
  ...
  {
    slug: "ultimate-finance-interview-guide",
    title: "Ultimate Finance Interview Guide",
    description: "130-page, 21-chapter all-in-one guide. Complete technical prep (accounting, EV, DCF, comps, M&A, LBOs, brain teasers, market knowledge) + full behavioral system (50 questions, CARL+ framework, classification matrix, firm-specific patterns) + networking templates, compensation data, and superday survival tactics. 2026 Edition.",
    longDescription:
...
*Looking to strengthen your fundamentals? The [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers the accounting and valuation knowledge funds expect.*
    `,
  },
  {
...
*Ready to nail the technical interviews? Our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers 400+ real questions with detailed answers.*
...
*Ready to nail your internship interviews? Our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers everything you'll be asked.*
...
*Ready to break into investment banking? Start with our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) to nail the interviews.*
...
*Ready for technicals? The [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers everything you'll be asked.*
    `,
  },
  {
...
*Ready to nail the technical questions? Our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers the 400+ questions you'll actually face.*
...
*Ready to master the technical questions? Check out our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide).*
    `,
  },
  {
...
*Want the full 400+ question bank with detailed answers? Get the [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide).*
...
*Want all 400+ questions with detailed answers? Get the [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide).*
...
*Got the interview? Make sure you don't blow it on technicals. Check out the [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide).*
    `,
  },
  {
...
*Ready to nail the technicals too? Check out the [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide).*
    `,
  },
  {
...
*Need to nail the interviews once you get them? Our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers 400+ real questions.*
...
*Preparing for interviews? Our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers everything you'll be asked regardless of your background.*
...
*Ready for technicals? The [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers 400+ questions.*
    `,
  },
  {
...
*Ready for interviews? The [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers everything you'll be asked.*
    `,
  },
  {
...
*Want to master all 400+ technical questions? Get the [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide).*
...
*Preparing for banking interviews? Our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers questions asked at all bank tiers.*
...
*Need to brush up on technicals? The [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers every question you'll face.*
    `,
  },
  {
...
*Ready to nail banking interviews? Our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers every question you'll face.*
...
*Want to master all M&A technicals? Our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers merger models, deal mechanics, and 400+ questions.*
...
*Ready for technicals? Our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers everything you'll be asked.*
    `,
  },
  {
...
*Ready to nail your interviews? Our [Finance Technical Interview Guide](/playbooks/finance-technical-interview-guide) covers 400+ questions.*
